...
export class FaceFocusEvaluator {
	...
	async start(): Promise<boolean> {
		try {
			...
			this.running = true;
			console.log("[chronote] FaceFocusEvaluator started");
			return true;
		} catch (err) {
			this.initStatus = null;
			...
			console.error("[chronote] FaceFocusEvaluator start failed:", err);
	...
	async stop(): Promise<void> {
		...
		this.confirmCounter = 0;
		this.pendingState = null;
		console.log("[chronote] FaceFocusEvaluator stopped");
	}
